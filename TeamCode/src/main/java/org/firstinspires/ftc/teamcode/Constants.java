...
public class Constants {
    ...
    public final double clampClosed = 0;
    public final double clampOpen = 0.4;
    public final double armDown = 0.9;
    public final double armUp = 0.46;
...
//    public final double ticksPerTok = PPR / (diameter / mmPI * Math.PI);
    ...
    //distance from left to center of ring
    public final int ringWidth = 120;
